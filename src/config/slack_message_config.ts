...
export class MessageTemplate {
  botMangUdinMessage(userId: string, channelId: string, channelName: string): string {
    return "Hey <@" + userId + "> nama gw Mang Udin, Gua sih cuman Ngebantuin si boss,\n" +
           "Tiap Jam 10 Pagi di channel `<#" + channelId + "|" + channelName + ">`\n\n" +
